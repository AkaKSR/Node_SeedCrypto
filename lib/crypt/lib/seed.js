...
module.exports = {
    ...
    string_to_utf8_hex_string: function (text) {
        var bytes = string_to_utf8_bytes(text);
        var hex_str = bytes_to_hex_string(bytes);
        return hex_str;
    },
    utf8_hex_string_to_string: function (hex_str) {
        var bytes = hex_string_to_bytes(hex_str);
        var str = utf8_bytes_to_string(bytes);
        return str;
    }
}